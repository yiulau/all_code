...
class V_fc_scaled_model_regression(bayes_model_class):
    def __init__(self,input_data,precision_type,model_dict):
        self.model_dict = model_dict
        super(V_fc_scaled_model_regression, self).__init__(input_data=input_data,precision_type=precision_type)
    def V_setup(self):
