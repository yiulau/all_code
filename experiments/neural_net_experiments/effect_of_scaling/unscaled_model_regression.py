...
class V_fc_unscaled_model_regression(bayes_model_class):
    def __init__(self,input_data,precision_type,model_dict):
        self.model_dict = model_dict
        super(V_fc_unscaled_model_regression, self).__init__(input_data=input_data,precision_type=precision_type)
    def V_setup(self):
        ...
        self.hidden_out = prior_out_fn(obj=self,name="hidden_out",shape=(1,self.num_units),global_scale=1)
