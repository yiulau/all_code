...
def run_nn_experiment(list_num_units,input_data,v_fun,test_set,type_problem):
    out_list = [None]*len(list_num_units)
    for i in range(len(list_num_units)):
        model_dict = {"num_units": list_num_units[i]}
