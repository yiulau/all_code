from experiments.neural_net_experiments.effect_of_scaling.unscaled_model_regression import V_fc_unscaled_model_regression
...
store_name = 'unscaled_normal_regression_fc1_sampler.pkl'
sampled = False
if sampled:
