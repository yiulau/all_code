...
input_dict = {"v_fun":[V_pima_inidan_logit],"epsilon":[0.1],"second_order":[True],"alpha":[1e6],
...
input_dict2 = {"v_fun":[V_pima_inidan_logit],"epsilon":[0.1],"alpha":[1e6],"second_order":[True],
              "evolve_L":[10],"metric_name":["softabs"],"dynamic":[False],"windowed":[True],"criterion":[None]}
...
from python2R.mcse_rpy2 import ess_mcse_repy2
from python2R.ess_batchmeans import ess_batchmeans_repy2
#print(ess_repy2(mcmc_samples))
#print(ess_mcse_repy2(mcmc_samples))
print(ess_batchmeans_repy2(mcmc_samples))
