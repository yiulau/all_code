...
#target_dataset = get_data_dict("pima_indian") # val = 0.3
target_dataset = get_data_dict("german") # val = 0.43
#target_dataset = get_data_dict("8x8mnist") # val = 0.7

v_generator = wrap_V_class_with_input_data(class_constructor=V_fc_model_1,input_data=target_dataset,prior_dict=prior_dict,model_dict=model_dict)
precision_type = "torch.DoubleTensor"
te2,predicted2 = test_error(target_dataset=target_dataset,v_obj=v_generator(precision_type=precision_type),mcmc_samples=mcmc_samples_mixed,type="classification",memory_efficient=False)
