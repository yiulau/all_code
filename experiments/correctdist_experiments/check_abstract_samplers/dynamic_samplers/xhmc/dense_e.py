...
input_dict = {"v_fun":[V_pima_indian_logit],"epsilon":["dual"],"second_order":[False],"cov":["adapt"],"xhmc_delta":[0.1],
              "metric_name":["dense_e"],"dynamic":[True],"windowed":[False],"criterion":["xhmc"]}
