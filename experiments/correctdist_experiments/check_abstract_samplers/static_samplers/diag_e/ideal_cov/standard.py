...
ideal_diag_cov = 1/(torch.from_numpy(correct_diag_cov).type("torch.DoubleTensor"))


input_dict3 = {"v_fun":[V_pima_indian_logit],"epsilon":["dual"],"second_order":[False],"cov":[ideal_diag_cov],
              "evolve_t":[1.5],"metric_name":["diag_e"],"dynamic":[False],"windowed":[False],"criterion":[None]}
