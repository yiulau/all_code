...
input_dict = {"v_fun":[V_pima_inidan_logit],"epsilon":[0.1],"alpha":[1e6],"second_order":[True],
              "evolve_L":[10],"metric_name":["softabs_outer_product"],"dynamic":[False],"windowed":[False],"criterion":[None]}
input_dict2 = {"v_fun":[V_pima_inidan_logit],"epsilon":[0.1],"alpha":[1e6],"second_order":[True],
              "evolve_L":[10],"metric_name":["softabs_outer_product"],"dynamic":[False],"windowed":[True],"criterion":[None]}
