...
mcmc_meta = mcmc_sampler_settings_dict(mcmc_id=0,samples_per_chain=2000,num_chains=4,num_cpu=4,thin=1,tune_l_per_chain=1000,
                                   warmup_per_chain=1100,is_float=False,isstore_to_disk=False,allow_restart=False,seed=232)
...
input_dict = {"v_fun":[V_pima_indian_logit],"epsilon":["dual"],"second_order":[False],"cov":["adapt"],
              "evolve_t":[1.5],"metric_name":["dense_e"],"dynamic":[False],"windowed":[True],"criterion":[None]}
ep_dual_metadata_argument = {"name":"epsilon","target":0.75,"gamma":0.05,"t_0":10,
