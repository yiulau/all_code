...
setup_ensemble_experiment(num_unit_list=num_units_list,num_ensemble_pts=30,train_set=train_set,validate_set=validate_set,test_set=test_set,save_name=save_name,seed=seed)
