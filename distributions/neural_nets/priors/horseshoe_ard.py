...
class horseshoe_ard(base_prior_new):
    ...
    def setup_parameter(self, obj, name, shape):
        ...
        setattr(obj, name+"_local_r1_obj", self.agg_log_local_r1_obj)
        setattr(obj, name+"_log_local_r2_obj", self.agg_log_local_r2_obj)
        setattr(obj, name+"_global_r1_obj", self.log_global_r1_obj)
