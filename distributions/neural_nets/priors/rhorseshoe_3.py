...
class rhorseshoe_3(base_prior_new):
    ...
    def setup_parameter(self,obj,name, shape):
        ...
        setattr(obj,name+"_z_obj_"+self.name,self.z_obj)
        setattr(obj,name+"_log_local_r1_obj_"+self.name,self.log_local_r1_obj)
        setattr(obj,name+"_log_local_r2_obj_"+self.name,self.log_local_r2_obj)
        setattr(obj,name+"_log_global_r1_obj_"+self.name,self.log_global_r1_obj)
        setattr(obj,name+"_log_global_r2_obj_"+self.name,self.log_global_r2_obj)
