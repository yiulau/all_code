...
# hierarchical prior for input to hidden units, scale = 1
#  normal prior for hidden to output units with variance 1/num_hidden_units

class V_fc_model_5(bayes_model_class):
    def __init__(self,input_data,precision_type,prior_dict,model_dict):
        self.prior_dict = prior_dict
        self.model_dict = model_dict
        super(V_fc_model_5, self).__init__(input_data=input_data,precision_type=precision_type)
    def V_setup(self):
