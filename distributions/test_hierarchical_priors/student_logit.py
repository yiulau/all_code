...
class V_logistic_regression_student(bayes_model_class):
    def __init__(self, input_data, precision_type):
        super(V_logistic_regression_student, self).__init__(input_data=input_data, precision_type=precision_type)
    ...
    def V_setup(self):
        ...
        prior_generator_fn = prior_generator("gaussian_inv_gamma_2")
