...
class V_fc_rhorseshoe(bayes_model_class):
    def __init__(self,input_data,precision_type):
        super(V_fc_rhorseshoe, self).__init__(input_data=input_data,precision_type=precision_type)
    def V_setup(self):
        ...
        self.num_units = 10
        prior_hidden_fn = prior_generator("rhorseshoe_3")
