...
mcmc_meta = mcmc_sampler_settings_dict(mcmc_id=0,samples_per_chain=11000,num_chains=1,num_cpu=1,thin=1,tune_l_per_chain=10000,
                                   warmup_per_chain=11000,is_float=False,isstore_to_disk=False)
