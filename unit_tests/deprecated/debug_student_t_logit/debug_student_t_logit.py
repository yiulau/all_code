...
from distributions.test_hierarchical_priors.student_logit import V_logistic_regression_student
...
v_generator =wrap_V_class_with_input_data(class_constructor=V_logistic_regression_student,input_data=input_data)
...
store_name = 'student_logit_sampler.pkl'
sampled = False
if sampled:
