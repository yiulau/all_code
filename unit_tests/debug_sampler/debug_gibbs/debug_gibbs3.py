...
# hyperparameter has lower ess across different seeds
...
mcmc_meta = mcmc_sampler_settings_dict(mcmc_id=0,samples_per_chain=4000,num_chains=4,num_cpu=4,thin=1,tune_l_per_chain=1000,
                                   warmup_per_chain=1100,is_float=False,isstore_to_disk=False,allow_restart=False,seed=11093)
...
input_dict = {"v_fun":[V_hierarchical_logistic_gibbs],"epsilon":["dual"],"second_order":[False],"max_tree_depth":[8],
