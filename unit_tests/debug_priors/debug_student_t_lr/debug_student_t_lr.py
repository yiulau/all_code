from distributions.test_hierarchical_priors.student_lr import V_student_lr
...
v_generator =wrap_V_class_with_input_data(class_constructor=V_student_lr,input_data=input_data)
