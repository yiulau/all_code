...
store_name = 'student_ard_fc1_sampler.pkl'
sampled = True
if sampled:
...
print(samples[:,:,hidden_in_sigma2_indices].shape)
...
print(mcmc_samples_mixed.shape)
...
print(max(mcmc_sd_vec)/min(mcmc_sd_vec)) # val = 2.3