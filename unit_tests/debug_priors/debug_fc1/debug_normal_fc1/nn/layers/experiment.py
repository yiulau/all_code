...
v_generator =wrap_V_class_with_input_data(class_constructor=V_fc_model_layers,input_data=input_data,prior_dict=prior_dict,model_dict=model_dict)
...
store_name = 'gnuts_normal_fc1_sampler.pkl'
sampled = False
if sampled:
...
te2,predicted2 = test_error(test_set,v_obj=v_generator(precision_type=precision_type),mcmc_samples=mcmc_samples_mixed,type="classification",memory_efficient=False)
