from distributions.neural_nets.fc_V_model_1_regression import V_fc_model_1_regression
...
v_generator =wrap_V_class_with_input_data(class_constructor=V_fc_model_1_regression,input_data=train_set,prior_dict=prior_dict,model_dict=model_dict)
...
store_name = 'gnuts_gaussian_inv_gamma2_fc1_sampler.pkl'
sampled = True
if sampled:
