...
input_dict = {"v_fun":[v_generator],"epsilon":["dual"],"second_order":[False],"cov":["adapt"],"max_tree_depth":[8],"xhmc_delta":[0.1],
...
store_name = 'xhmc_hs3_55_fc1_sampler.pkl'
sampled = False
if sampled:
...
print(max(mcmc_sd_vec)/min(mcmc_sd_vec)) # val = 2.4