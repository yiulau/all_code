...
input_dict = {"v_fun":[V_2dnormal],"epsilon":[0.01],"second_order":[False],"max_tree_depth":[4],
...
print("percent hit max tree depth {}".format(percent_diagnostics(diagnostics,"hit_max_tree_depth")))